...
const features = [
  {
    title: 'Psychiatry-aware notes',
    description:
      'Draft visit notes with psychiatric history, MSE, risk assessment, diagnosis, and plan sections already in mind.',
  },
  {
    title: 'Measurement-based care',
    description:
      'Keep PHQ-9, GAD-7, PCL-5, AUDIT-C, and other common scales close to the encounter workflow.',
  },
  {
    title: 'Clinician review first',
    description:
      'AI output is treated as a draft so the clinician remains responsible for review, edits, and final sign-off.',
  },
  {
    title: 'Privacy-minded foundation',
    description:
      'Designed with encryption, access controls, audit trails, and HIPAA-ready workflows as product requirements.',
  },
]
...
function Header() {
  return (
    <header className="site-header">
      ...
      <Link className="nav-cta" to="/templates">View templates</Link>
    </header>
  )
}
      ...
      <div className="preview-grid">
        ...
        <aside className="score-panel">
          ...
          <div className="risk-card">
            ...
            <strong>Needs clinician check</strong>
          </div>
        </aside>
      </div>
    </div>
    ...
    <>
      <section className="hero-section">
        <div className="hero-copy">
          ...
          <p className="hero-text">
            iScribe helps psychiatry teams draft structured notes, track rating scales, and organize visit templates in one clean workspace.
          </p>
      ...
      <section className="features-section" id="features">
        <div className="section-heading">
          ...
          <p>
            The first version focuses on the foundation: notes, templates, measures, and clinician-controlled review.
          </p>
        </div>
  ...
  return (
    <PlaceholderPage
      ...
      items={[
        {
          kicker: 'Planned',
          title: 'Common psychiatry scales',
          description: 'PHQ-9, GAD-7, PCL-5, AUDIT-C, MDQ, ASRS, and other validated tools can live here.',
        },
        {
          kicker: 'Planned',
          title: 'Score interpretation',
          description: 'Surface score ranges, change over time, and prompts for clinician review without replacing clinical judgment.',
        },
        {
          kicker: 'Planned',
          title: 'Longitudinal tracking',
          description: 'Give clinicians a quick view of symptom trajectories across visits.',
        },
      ]}
    />
  )
      ...
      items={[
        {
          ...
          description: 'Chief concern, HPI, psychiatric history, substance use, MSE, formulation, assessment, and plan.',
        },
        {
          kicker: 'Draft',
          title: 'Medication management follow-up',
          description: 'Symptoms, adverse effects, adherence, safety review, medication changes, and follow-up plan.',
        },
        {
          kicker: 'Draft',
          title: 'Risk assessment note',
          description: 'Suicidal ideation, protective factors, acute risk level, mitigation steps, and safety planning.',
        },
      ]}
    />
  )
